...
class WarThunderVehicleDataProcessor:
    """
...
def main():
    """
    Main function to run the War Thunder vehicle data processor from command line.
    """
    parser = argparse.ArgumentParser(
        description="Process War Thunder vehicle data into structured format",
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Path to wpcost.blkx JSON file",
    )
    ...
    for file_path in [args.wpcost_blkx, args.unittags_blkx, args.units_csv]:
    ...
    try:
        logger.info("Starting War Thunder vehicle data processing...")
