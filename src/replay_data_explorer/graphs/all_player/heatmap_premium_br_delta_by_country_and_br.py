...
def create_heatmap_premium_br_delta_by_country_and_br(global_performance_df: pd.DataFrame, *, country_filters=[]):
    """
    ...
    premium_data = (
        ...
        .groupby(["player.country", "player.battle_rating"])["player.battle_rating_delta"]
        .agg(["mean", "count"])
        .reset_index()
    )
