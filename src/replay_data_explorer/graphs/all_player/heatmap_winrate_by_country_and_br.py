...
def create_heatmap_winrate_by_country_and_br(
    ...
    *,
    ...
    """
    Create an interactive Plotly heatmap showing win rates for all players by country and battle rating.
    ...
    # Filter by replay BR (only battles where the replay BR is present)
    ...
    # Group by country and battle rating (using replay BR)
    ...
    winrate_pivot = grouped.pivot(index="player.country", columns="battle_rating", values="win_rate")
    appearances_pivot = grouped.pivot(index="player.country", columns="battle_rating", values="appearances")
    wins_pivot = grouped.pivot(index="player.country", columns="battle_rating", values="wins")
