...
def create_bar_squad_performance(player_performance_df: pd.DataFrame, *, player_name, country_filters=[]):
    """
    Create an interactive Plotly bar chart showing average player score by squad size.

    Args:
        player_performance_df: DataFrame with performance data (should include squad, team, auto_squad columns)
